...
var {RequiredPropertyError} = require("./edi-errors.js");


var flattenProperty = function(definitions, obj) {
...
var flattenRefs = function(definitions, obj) {
  if (obj.type === "object") {
...
var mergeDefaultEdiOpts = function(options) {
  var opts = options || {};
  _.defaults(opts, {
